...
public class FloatTTypeListener extends NumberFormatVerifyListener {
	...
	public FloatTTypeListener (NumberFormat formatter, boolean allowEmpty, Float minValue, Float maxValue) {
	...
	public void verifyText(VerifyEvent e){
		...
		if (!"".equals(futureText)){
			...
			if (decimalSeparator != -1 ) {
				...
				decPart = new Integer(futureText.substring(decimalSeparator+1, futureText.length() - 1));
			...
			if (this.minValue != null) {
				...
				int minValueIntPart = new Integer(minValueString.substring(0, decimalSeparatorMinValue));
				int minValueDecPart = new Integer(minValueString.substring(decimalSeparatorMinValue+1, minValueString.length() -1 ));
			...
			if (this.maxValue != null) {
				...
				int maxValueIntPart = new Integer(maxValueString.substring(0, decimalSeparatorMaxValue));
				int maxValueDecPart = new Integer(maxValueString.substring(decimalSeparatorMaxValue+1, maxValueString.length()-1 ));
