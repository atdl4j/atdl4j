package br.com.investtools.fix.atdl.ui.swt.test.applications;
...
import br.com.investtools.fix.atdl.ui.swt.impl.SWTStrategiesUI;
import br.com.investtools.fix.atdl.ui.swt.impl.SWTStrategiesUIFactory;
import br.com.investtools.fix.atdl.ui.swt.test.DebugMouseTrackListener;
...
public class SWTBuilder {
	...
	protected static void parse(String filepath) throws XmlException,
		...
		for (StrategyT strategy : strategiesDocument.getStrategies()
			...
			ParameterUI<?> sideWidget = ui.getParameterWidget("Variance");
			if (sideWidget != null) {
