 ...
 */
public class SwingExpandBarResizer
	extends ExpandAdapter
{
	protected Composite composite;
	
	public SwingExpandBarResizer( Composite aComposite )
	{
	...
	{
		SwingStrategyPanelHelper.revalidateLayoutAsync( (ExpandBar)composite.getParent() );
	}
