...
public class SwingRadioButtonListener
		implements Listener
{
	private static final Logger logger = Logger.getLogger( SwingRadioButtonListener.class );

	private List<Button> buttons;

	public SwingRadioButtonListener()
	{
	...
	public void addButton(SwingButtonWidget buttonWidget)
	{
